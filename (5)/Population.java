...
public class Population {
	 ...
	 */
	public double getnNumDaysMultiplied(){
	...
	/**
	 * Get current population based on the starting number
	 * current population = starting number * avg daily increase
	 * @return the currentPopulation
	 */
	public double getCurrentPopulation(){
		this.currentPopulation = (((double)this.currentPopulation * (double)this.avgDailyIncrease) + (double)this.currentPopulation);
